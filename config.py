...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7264263787:AAGHLqrEGUjGVWiwGpFNKXamAEdcqRfmdyI")  # ⚠️ Required
    ...
    ADMIN = [int(admin) if id_pattern.search(
        admin) else admin for admin in os.environ.get('ADMIN', '6704116482').split()]  # ⚠️ Required
    
    FORCE_SUB = os.environ.get("FORCE_SUB", "") # ⚠️ Required Username without @
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002229723026"))  # ⚠️ Required
...
"""
    ...
    ABOUT_TXT = """<b>╭───────────⍟
• ᴍy ɴᴀᴍᴇ : {}
• ᴜᴘᴅᴀᴛᴇꜱ : <a href=https://t.me/IonosHub>ᴋᴘꜱ ʙᴏᴛꜱ</a>
╰───────────────⍟ """
...
<b>•></b> /set_caption - Uꜱᴇ Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Tᴏ Sᴇᴛ ᴀ Cᴜꜱᴛᴏᴍ Cᴀᴩᴛɪᴏɴ
Exᴀᴍᴩʟᴇ: <code> /settings - settings 📕
💾 Sɪᴢᴇ: {filesize}
